...
public static class WebApplicationBidExtensions
{
    ...
    {
        app.MapGet("/house/{houseId}bids", async (int houseId, IHouseRepository houseRepo, BidRepository bidRepo) => {
        ...
        app.MapPost("/house/{houseId}/bids", async (int houseId, [FromBody] BidDto dto, IBidRepository repo) =>{
